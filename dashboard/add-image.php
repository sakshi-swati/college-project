      ...
      <div class="form-w3layouts">
            ...
            <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <a href="index.php">Dashboard</a>  / Add Images
                        </header>
						<br><br>
                        <div class="panel-body">
                            ...
                            Add Image
                                ...
                                <div class="form-group">
                                    <label for="subject">Enter ID (For Which The Image Is-)<span style="color:red">*</span></label>
                                    <input type="text" class="form-control" id="txtAccid" placeholder="Enter Acc Id">
                                </div>
								<form action="upload-image.php" method="post" enctype="multipart/form-data" target="uploadTarget" onsubmit="startUpload();" >
		...
		<div>
            <embed id="UploadedFile" src="" width="200px" height="200px">
                                ...
                                <div id="msg"></div>
                                <button type="button" class="btn btn-info" id="btnImage">Add Image</button>
