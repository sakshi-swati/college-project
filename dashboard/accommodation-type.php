...
<section class="wrapper">
            ...
            <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <a href="index.php">Dashboard</a>  /   Accommodation Type
                        </header>
						<br><br>
                        <div class="panel-body">
                            ...
                            Accommodation Type
                                ...
                                <div id="msg"></div>
                                <button type="submit" class="btn btn-info" id="btnAccommoType">Add Type</button>	<br>
	...
	<div class="row w3-res-tb">
        ...
        <div class="card-body" id="disp_grid_type">
